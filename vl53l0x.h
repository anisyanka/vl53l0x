...
/*
	...
	Default init is: interrupt enabled when VL53L0X_GPIO_FUNC_NEW_MEASURE_READY.
*/
vl53l0x_ret_t vl53l0x_init(vl53l0x_dev_t *dev);

/* Power control. Do nothing if xshut_set() and xshut_reset() weren't implemented.
See vl53l0x_ll_t s structure */
...
vl53l0x_ret_t vl53l0x_deactivate_gpio_interrupt(vl53l0x_dev_t *dev); /* Disable any IRQ type */
 ...
 * You will receive INT from the GPIO after each measurement in continuous mode (~40ms)
 **/
